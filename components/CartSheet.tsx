    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col">
        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            {isLoading ? (
              ...
              <div className="space-y-4 px-1">
                {cartItems.map((item) => (
                  <div
                    key={item.id}
                    className="flex gap-4 p-4 border rounded-lg bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow"
                  >
          ...
          {cartItems.length > 0 && (
            <div className="border-t bg-gray-50/50 dark:bg-gray-900/50 p-4 rounded-lg space-y-4">

...
export default function BlogPost({}: BlogPostParams) {
  return (
    <article className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Category */}
      <div className="mb-4">
        <span className="text-sm text-blue-600 font-medium">Self-help</span>
      </div>
      ...
      <div className="space-y-6 text-gray-700">
        <p>
          ...
          est et lectus varius, at hendrerit ex cursus. Curabitur eget ex
          interdum, ultrices nisi ac, convallis magna. Aliquam erat volutpat. Ut
          non maximus est, efficitur vestibulum dui. Sed nec.
        </p>
        ...
        <p>
          ...
          est et lectus varius, at hendrerit ex cursus. Curabitur eget ex
          interdum, ultrices nisi ac, convallis magna. Aliquam erat volutpat. Ut
          non maximus est, efficitur vestibulum dui. Sed nec purus ut magna. Sed
          nunc purus, dictum eget maximus sed, tincidunt egestas turpis. Sed et
          elit sem. Cras vitae purus diam. Vivamus placerat ultricies ipsum quis
          bibendum et amet, consequat adipiscing elit. Sed augue est, sem.
        </p>

        <div className="bg-gray-50 p-6 rounded-md border-l-4 border-blue-500">
          <p className="italic text-gray-600">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Commodo
            dictum magna, amet, consequat ipsum ipsum dolor sit amet,
            consectetur adipiscing elit. Commodo dictum magna, amet, consequat
            ipsum ipsum.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="mt-1">
                <span className="text-red-500 font-bold text-sm">$39.99</span>
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="mt-1">
                <span className="text-gray-700 font-bold text-sm">$29.99</span>
              </div>
            </div>
          </div>
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="mt-1">
                <span className="text-green-500 font-bold text-sm">$24.99</span>
                <span className="text-gray-400 text-xs line-through ml-1">
                  $34.99
                </span>
              </div>
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="mt-1">
                <span className="text-gray-700 font-bold text-sm">$19.99</span>
              </div>
            </div>
          </div>
        </div>
